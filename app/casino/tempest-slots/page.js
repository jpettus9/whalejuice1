...
export default function Game(){
  ...
  return (
    <div className='mx-auto max-w-3xl px-4 sm:px-6 lg:px-8 py-10'>
      <h1 className='text-3xl font-extrabold'>Tempest Slots</h1>
      <div className='mt-6 rounded-3xl border border-white/10 bg-gradient-to-br from-white/5 to-cyan-400/10 p-6'>
        <div className='h-48 rounded-2xl bg-white/5 border border-white/10 grid place-items-center text-white/50'>[ Tempest Slots Placeholder ]</div>
